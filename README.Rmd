...
# Barplot with 4 bars with a discrete X axis filled with accessible colours
sim_series(4) %>%
  ggplot(aes(x = X, y = Z, fill = X)) +
  geom_col() +
  DHSC_accessible_4() +
  theme_dhsc() +
  ggtitle("DHSC_accessible_4") +
  zero_y_padding()

# Barplot with 5 bars with a ordinal X axis filled with accessible colours
sim_series(5) %>%
  ggplot(aes(x = X, y = Z, fill = X)) +
  geom_col() +
  DHSC_accessible_5_gradient() +
  theme_dhsc() +
  ggtitle("DHSC_accessible_5_gradient") +
  zero_y_padding()
