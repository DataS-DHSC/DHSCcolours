...
**Warning - this package will soon be deprecated and replaced with a central GSS colours package, that conforms to accessibility requirements. Ensure charts being used in your publications adhere to [Goverment Analysis Function guidelines](https://analysisfunction.civilservice.gov.uk/policy-store/data-visualisation-colours-in-charts/).**
